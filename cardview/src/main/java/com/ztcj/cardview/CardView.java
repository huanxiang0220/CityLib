...
public class CardView extends FrameLayout {
    ...
    /**
     * CardView requires to have a particular minimum size to draw shadows before API 21. If developer also sets min
     * width/height, they might be overridden.
     * <p>
     * CardView works around this issue by recording user given parameters and using an internal method to set them.
     */
     ...
     * <p>
     * This may cause Cards to have different sizes between Lollipop and before Lollipop. If you need to align CardView
     * with other Views, you may need api version specific dimension resources to account for the changes. As an
     * alternative, you can set this flag to <code>true</code> and CardView will add the same padding values on
     * platforms Lollipop and after.
     * <p>
     ...
     * calling {@link View#setPadding(int, int, int, int)}.
     *
     ...
     * <p>
     * Calling this method has no effect if device OS version is Lollipop or newer and {@link #getUseCompatPadding()}
     * is
     * <code>false</code>.
     *
    ...
    /**
     * Returns whether CardView should add extra padding to content to avoid overlaps with rounded corners on
     * pre-Lollipop platforms.
     *
     * @return True if CardView prevents overlaps with rounded corners on platforms before Lollipop. Default value is
     * <code>true</code>.
     */
    public boolean getPreventCornerOverlap() {
    ...
    /**
     * On pre-Lollipop platforms, CardView does not clip the bounds of the Card for the rounded corners. Instead, it
     * adds padding to content so that it won't overlap with the rounded corners. You can disable this behavior by
     ...
     *
     * @param preventCornerOverlap Whether CardView should add extra padding to content to avoid overlaps with the
     *                             CardView corners.
     * @attr ref android.support.v7.cardview.R.styleable#CardView_cardPreventCornerOverlap
