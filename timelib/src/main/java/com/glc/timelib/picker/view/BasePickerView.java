...
import com.glc.timelib.picker.listener.OnDismissListener;
import com.glc.timelib.picker.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    public void createDialog() {
        if (dialogView != null) {
            mDialog = new Dialog(context, R.style.picker_dialog);
