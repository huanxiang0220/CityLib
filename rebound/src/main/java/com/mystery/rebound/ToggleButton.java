...
public class ToggleButton extends View {
     ...
     * 开启颜色
     */
    private int onColor = Color.parseColor("#894292");
    /**
     * 关闭颜色
     */
    private int offBorderColor = Color.parseColor("#EEEEEE");
    /**
     * 灰色带颜色 --- 界面打开时看到的颜色
     */
    private int offColor = Color.parseColor("#EEEEEE");
    ...
    public void setup(AttributeSet attrs) {
        ...
        offBorderColor = typedArray.getColor(R.styleable.ToggleButton_ToffBorderColor, offBorderColor);
        onColor = typedArray.getColor(R.styleable.ToggleButton_TonColor, onColor);
        spotColor = typedArray.getColor(R.styleable.ToggleButton_TspotColor, spotColor);
        offColor = typedArray.getColor(R.styleable.ToggleButton_ToffColor, offColor);
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.ToggleButton_TborderWidth, borderWidth);
        defaultAnimate = typedArray.getBoolean(R.styleable.ToggleButton_Tanimate, defaultAnimate);
        typedArray.recycle();
