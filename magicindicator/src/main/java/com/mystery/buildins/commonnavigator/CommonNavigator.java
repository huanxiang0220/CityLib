package com.mystery.buildins.commonnavigator;
...
import com.mystery.NavigatorHelper;
import com.mystery.Rom;
import com.mystery.ScrollState;
import com.mystery.abs.IPagerNavigator;
import com.mystery.buildins.commonnavigator.abs.CommonNavigatorAdapter;
import com.mystery.buildins.commonnavigator.abs.IMeasurablePagerTitleView;
...
import com.mystery.buildins.commonnavigator.model.PositionData;
...
public class CommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    /**
     * TODO：MagicIndicator切换字体粗细在OPPO A5下的bug
     * 在OPPO a5、a77系列下设置字体粗体会导致父控件在不断的调用onLayout
     */
    ...
    public void onSelected(int index, int totalCount) {
        ...
        if (totalCount != 0 && mIndex == index && Rom.isOppo()) {
            number++;
            if (number > 3) return;
        } else {
            number = 0;
